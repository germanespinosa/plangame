let gameStatus = {
    ...
    showMenu: function (p){
        ...
        gameStatus.mapSpinner = new Spinner(game.width * .215,game.height * .52,game.width *.55,game.height *.075,options,"8bit", groups.status);
        ...
        let playButton = gameStatus.showMessage("PLAY",{w:.8,h:.1},0xD34F1D,{x:.4,y:.85});
